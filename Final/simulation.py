...
if __name__ == "__main__":
    ...
    print("Plotting and saving group-specific results for uniform allocation...")
    ...
    print("Plotting and saving group-specific results for optimal allocation...")
    ...
    print("Plotting and saving total results for uniform allocation...")
    ...
    print("Plotting and saving total results for optimal allocation...")
